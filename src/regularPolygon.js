...
export default function() {
  ...
  regularPolygon.sides = function(_) {
    return arguments.length ? (sides = typeof _ === "function" ? _ : constant(+_), regularPolygon) : sides;
  };

  regularPolygon.radius = function(_) {
    return arguments.length ? (radius = typeof _ === "function" ? _ : constant(+_), regularPolygon) : radius;
  };

  regularPolygon.flatTop = function(_) {
    return arguments.length ? (flatTop = typeof _ === "function" ? _ : constant(_), regularPolygon) : flatTop;
  };
